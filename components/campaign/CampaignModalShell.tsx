 ...
 *
 * Same locked pattern as ApplySuccessModal, for the same reason: tapping the
 * backdrop does NOT close this modal. A sign-up or sign-in form is exactly
 * the kind of thing a stray tap while reaching for something else can wipe
 * out — someone mid-form loses everything they've typed. Only the X button
 * or Escape closes it, matching ApplySuccessModal's own reasoning rather
 * than the more common (but riskier, for a form) tap-outside convention.
 */
